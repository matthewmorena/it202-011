...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #401060;">
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                ...
                <?php if (is_logged_in()) : ?>
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo get_url('about.php'); ?>">About Us</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo get_url('terms.php'); ?>">Terms of Use</a></li>
